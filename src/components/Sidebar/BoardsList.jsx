      ...
      return (
            ...
            {boards.map(({_id, title, icon}) => (
             <li className={scss.boardsListItem}
               >
                  ...
                  to={`/home/${_id}`}
                      key={_id}
                      className={`${scss.boardsListItemWrap} ${(firstBoardId === _id && firstBoardId === activeBoardId) ? scss.boardsListItemFirst : ''} `}
         ...
         <button
          ...
          >
            ...
            {showEditBoardModal && (<Modal onClose={togleModal}>
               <div style={ {width: "200px", height: "200px", background: "red"  }}  className={scss.boardsListActiveFlag}></div>
            </Modal>)}
      </ul>       
   )
};
